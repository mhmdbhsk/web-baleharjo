    ...
    <div className="flex items-center text-foreground">
      ...
      {searchValue && (
        <Button
          ...
          variant="ghost"
          className={cn(
            'absolute right-0.5 top-1/2 flex size-8 -translate-y-1/2 cursor-pointer items-center justify-center  border-none bg-transparent text-popover-foreground hover:bg-transparent'
          )}
          onClick={clearSearch}
          title={i18n.clear}
          aria-label="Clear"
